  ...
  <div>
      <el-form ref="form" label-width="80px">
        ...
        <el-form-item label="平台属性">
          <!-- 一行有多个下拉框 行内表单 :inline -->
          <el-form :inline="true" ref="form" label-width="80px">
            <el-form-item :label="attr.attrName" v-for="(attr,index) in attrInfoList" :key="attr.id">
              <!-- attrIdAndValueIdd定义在遍历的每一项attr中 data中不用定义 -->
...
export default {
  ...
  data() {
    return {
      ...
      spu: {},
      //收集图片的数据字段:但是需要注意，收集的数据目前缺少isDefault字段，将来提交给服务器数据的时候，需要整理参数 所以不能直接收集到spuImageList或skuInfo的skuImageList中
      imageList:[]
    };
  },
  methods: {
    ...
    async save() {
      ...
      //   }
      // })
      // // 将整理好的参数赋值给skuInfo.skuImageList
